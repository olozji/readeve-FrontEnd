...
const MapSearch = ({
  ...
  markerImage,
  mapHeight,
}: MapSearchProps): React.ReactElement => {
    ...
    <div className="pb-10 border-b-2">
      ...
      <div className="flex sm:flex-col">
        ...
        <div
          ...
          className="scrollBar w-[40%] sm:w-[100%] bg-white h-full max-h-[40vh] sm:max-h-[20vh] bg-opacity-80 overflow-y-auto rounded-lg"
        >
          {Place.length === 0 ? (
            ...
            <>
              {Place.map((item: any, i) => (
                ...
                >
                  <div>
                    <div
                      className="text-[#E57C65] font-bold text-md"
                      style={{
                        paddingTop: '10px',
                        marginBottom: '10px',
