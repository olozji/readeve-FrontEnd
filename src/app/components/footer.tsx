...
const Footer= () => {
    return (
      <footer 
      className="mx-auto text-center bottom-0 footer md:p-[3rem] sm:p-[1rem] bg-base-200 border border-slate-200 text-[#AAAAAA]">
      <div className="grid md:grid-flow-col gap-4">
        ...
        <div className="footer_hidden text-xs md:text-sm sm:text-xs">©2024. 읽는곳곳 Co. All Rights Reserved. Prod By. SWYP</div>
      </footer>
    );
  }
